...
<template>
    <div class='storeRentHouse'>
        <div class='title'>
            <div class='left'>
                <div class='text1'>当前位置：房源管理 ➟ 租房</div>
                <div class="left">
        ...
        <template>
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="city_name" label="月租金" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    state(row) {
      ...
      see(row) {
      this.$router.push({ name: "storeRentingHouseSeeInfo" });
    },
    async getExList() {
