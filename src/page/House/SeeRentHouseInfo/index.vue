                ...
                <div class='company-block-one'>
                    ...
                    <div class='content'>
                        ...
                        <el-form :model="sumbitForm" class='form'>
                            ...
                            <div class='block-info'>
                                <div class='input-title pd-r-28px'>月租金：</div>
                                <el-form-item class='input'>
                                    {{"2800"}}
                                </el-form-item>
                            </div>
                            ...
                            <div class='block-info'>
                                <div class='input-title'>租房急迫度：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                                <div class='input-title'>出租原由：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>

                            <div class='block-info'>
                                <div class='input-title'>租房意愿度：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                ...
                <div>
                    <div class='content'>
                        ...
                        <el-form :model="sumbitForm" class='form'>
                            ...
                            <div class='block-info left-200px'>
                ...
                <div>
                    <div class='content'>
                        ...
                        <el-form :model="sumbitForm" class='form'>
                            ...
                            <div class='block-info'>
                                <div class='input-title'>楼层类型：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                                <div class='input-title'>年代：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div><br>
                            <div class='block-info'>
                            ...
                            <div class='block-info'>
                                <div class='input-title pd-r-14px'>楼户比：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                                <div class='input-title'>装修：</div>
                                <el-form-item class='input'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                ...
                <div>
                    <div class='content'>
                        ...
                        <el-form :model="sumbitForm" class='form'>
                            ...
                            <div class='block-info'>
                                <div class='input-title'>勘察完成时间：</div>
                                <el-form-item class='input1'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
                ...
                <div>
                    <div class='content'>
                        ...
                        <el-form :model="sumbitForm" class='form'>
                            ...
                            <div class='block-info'>
                                <div class='input-title pd-r-28px'>报备经纪人：</div>
                                <el-form-item class='input1'>
                                    {{"张三"}}
                                </el-form-item>
                            </div><br>
                            ...
                            <div class='block-info'>
                                <div class='input-title'>报备经纪人电话：</div>
                                <el-form-item class='input1'>
                                </el-form-item>
                            </div>
                            <div class='block-info'>
