...
<template>
    <div class='dealTwoHouse project'>
        <div class='title'>
            <div class='left'>
                <div class="tab-block">
                    <div class='text1'>当前位置：交易管理 ➟ 二手房</div>
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%" class="mt-30">
                ...
                <el-table-column prop="gave_code" label="客户姓名" align='center'></el-table-column>
                <el-table-column prop="store_name" label="联系电话" align='center' width="110px"></el-table-column>
                <el-table-column prop="contact" label="所属门店" align='center'></el-table-column>
                <el-table-column prop="contact_tel" label="所属公司" align='center'></el-table-column>
                <el-table-column prop="developer_name" label="项目名称" align='center'></el-table-column>
                <el-table-column prop="is_distribution" label="项目地址" align='center' width="200px"></el-table-column>
                <el-table-column prop="start_time" label="推荐经纪人" align='center'></el-table-column>
                <el-table-column prop="end_time" label="带看经纪人" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    see(row) {
      this.$router.push({ name: "dealTwoHouseSeeInfo" });
    },
    getIndex(row) {
