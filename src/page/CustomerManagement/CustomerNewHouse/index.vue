...
<template>
    <div class='customerNewHouse project'>
        <div class='title'>
            <div class='left'>
                <div class='text1'>当前位置：客户管理 ➟ 新房</div>
                <div class="left">
                    <el-button class='tip' :class="tipActiveIndex==1?'active':''" type="text" @click="clickTip(1)">待确认客户</el-button>
                    <el-button class='tip' :class="tipActiveIndex==2?'active':''" type="text" @click="clickTip(2)">有效客户</el-button>
                    <el-button class='tip' :class="tipActiveIndex==3?'active':''" type="text" @click="clickTip(3)">无效客户</el-button>
                    <el-button class='tip' :class="tipActiveIndex==4?'active':''" type="text" @click="clickTip(4)">已成交客户</el-button>
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%" class="mt-30">
                ...
                <el-table-column prop="contact_tel" label="推荐时间" align='center' width="110px"></el-table-column>
                <el-table-column prop="developer_name" label="到访时间" align='center'></el-table-column>
                <el-table-column prop="is_distribution" label="认购时间" align='center' width="80px"></el-table-column>
                <el-table-column prop="start_time" label="签约时间" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    see(row) {
      this.$router.push({ name: "customerNewHouseSeeInfo" });
    },
    getIndex(row) {
