...
.companyArriveOnVisit {
  ...
  .el-table td {
    padding: 6px 0;  //如果有操作的话。 未0
    color: #333;
  }
}
</style>
<template>
  <div class='companyArriveOnVisit'>
    <div class='title'>

      <div class='tab-block'>
        <div class='text1'>当前位置：客户管理 → 到访客户</div>
        <div class="search-block">
          ...
          <el-button icon="el-icon-search" circle @click="getVisitList"></el-button>
        </div>
        <div class='btn'>
    ...
    <el-table :data="tableData" border style="width: 100%" class="mt-30">
      ...
      <el-table-column prop="visit_time" label="到访时间" align='center' width="180px"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getVisitList() {
      ...
      let res = await this.api.getVisitList(this.searchObj);
      if (res.code == 200) {
