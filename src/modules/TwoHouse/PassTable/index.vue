...
<template>
    <div>
         <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="developer_name" label="项目负责人" align='center' ></el-table-column>
                <el-table-column prop="company_relation" label="联系电话" align='center' ></el-table-column>
                <el-table-column prop="company_relation" label="账号分配" align='center'></el-table-column>
                <el-table-column prop="subordinate_company" label="失效时间" align='center'></el-table-column>
                ...
                <el-table-column label="操作" align='center' width="270px">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" @click='showAdd(3, scope.row)'>账号管理</el-button>
                         <el-button type="text" @click='showAdd(3, scope.row)'>编辑楼盘字典</el-button>
                    </template>
                </el-table-column>
            </el-table>
    </div>
