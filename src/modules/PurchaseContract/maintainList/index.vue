...
<template>
  <div>
    <el-table :data="tableData" border style="width: 100%" class="mt-30">
      ...
      <el-table-column prop="agent_tel" label="代办人电话" align='center' width="100px"></el-table-column>
      <el-table-column label="房号" align='center' width="90px">
      ...
      <el-table-column prop="disabled_state" label="状态" align='center' width="150px"></el-table-column>
      <el-table-column prop="operation" label="操作" align='center' width="140px">
        <template slot-scope="scope">
          ...
          <el-button type="text" @click='tart(scope.row,3)'>挞定</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
